...
<body>
	...
	<section id="sessao-reservas">
		<jsp:include page="tabela-reservas.jsp"></jsp:include>
	</section>
	<jsp:include page="modal-reservas.jsp" />
	</div>
</body>
...
<script src="${path}/static/js/reservas.js"></script>
</html>